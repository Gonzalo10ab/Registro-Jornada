    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-dropdown-link :href="route('profile.edit')">
                            ...
                            @auth
                                @if (Auth::user()->rol_id == 1)
                                    <x-dropdown-link :href="route('admin.usuarios')">
                                        {{ __('Administración') }}
                                    </x-dropdown-link>
                                @endif
                            @endauth
                ...
                <!-- Botón de Modo Oscuro (Justo al lado del usuario) -->
                <button type="button" onclick="toggleDarkMode()"
                    class="ml-4 font-medium text-gray-800 dark:text-gray-200 rounded-full 
                hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-200 transition-all duration-300">

                    <span id="darkModeIcon" class="group inline-flex shrink-0 justify-center items-center size-9">
                        <!-- El icono cambiará con el script -->
